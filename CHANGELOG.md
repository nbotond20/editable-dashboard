...
- `doubleClickToMaximize` prop on `DashboardProvider` (default: `true`) — double-clicking the drag handle toggles a widget between full width and its previous size
- `onDoubleClick` optional handler on `DragHandleProps`
